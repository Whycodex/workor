    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-100 text-amber-700 rounded-full uppercase">
          ...
          <p className="pt-1">No 1 Task Management tool</p>
        </div>
      ...
      >
        ...
        error eaque unde quibusdam iste iusto officia? Amet, illo? Possimus eius
        asperiores porro soluta illo, aperiam maiores placeat sapiente eaque.
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Get Workor for free</Link>
      </Button>
    </div>
  );
};
